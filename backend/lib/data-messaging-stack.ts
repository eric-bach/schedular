...
export class DataMessagingStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: SchedularDataStackProps) {
    ...
    new CfnTemplate(this, 'ConfirmationEmailTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'Appointment Confirmation' : '[TEST] Appointment Confirmation',
        htmlPart:
    ...
    new CfnTemplate(this, 'CancellationEmailTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'Appointment Cancellation' : '[TEST] Appointment Cancellation',
        htmlPart:
    ...
    new CfnTemplate(this, 'ReminderEmailTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'Appointment Reminder' : '[TEST] Appointment Reminder',
        htmlPart:
    ...
    new CfnTemplate(this, 'AdminAppointmentConfirmationTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'You have a new booking' : '[TEST] You have a new booking',
        htmlPart:
    ...
    new CfnTemplate(this, 'AdminAppointmentCancellationTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'You have a cancellation' : '[TEST] You have a cancellation',
        htmlPart:
    ...
    new CfnTemplate(this, 'AdminDailyDigestTemplate', {
      template: {
        subjectPart: props.envName === 'prod' ? 'Your upcoming appointments' : '[TEST] Your upcoming appointments',
        htmlPart:
