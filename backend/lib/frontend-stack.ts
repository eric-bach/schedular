...
import { AdventFrontendStackProps } from './types/AdventStackProps';

dotenv.config();

export class FrontendStack extends Stack {
  constructor(scope: Construct, id: string, props: AdventFrontendStackProps) {
    ...
    const hostingBucket = new Bucket(
      this,
      `${props.appName}WebsiteHostingBucket`,
      {
    ...
    const distribution = new CloudFrontWebDistribution(
      this,
      `${props.appName}WebsiteDistribution`,
      {
